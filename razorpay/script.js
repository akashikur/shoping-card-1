...
let total = JSON.parse(totalAmount);
...
document.getElementById("rzp-button1").onclick = function (e) {
  var options = {
    ...
    amount: total, //check this out if this is paisa or INR // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
    currency: "INR",
    name: "accio portal",
